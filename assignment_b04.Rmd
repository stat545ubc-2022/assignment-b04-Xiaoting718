...
Make a plot of the most common words in the book(`Sense and Sensibility`) excluding “stop words”.
...
A example of rule #1: words begin with consonant sounds or consonant clusters.
```{r}
pig_latin_xtl("Hello")
```
